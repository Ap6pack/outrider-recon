...
class Audit:
    ...
    def check_adrs(self):
        ...
        self.ok('required ADR sequence','ADR 0001 through 0011 are present') if not miss else self.fail('required ADR sequence','missing '+', '.join(miss))
