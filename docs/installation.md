...
Open the Outrider 4.0.0 GitHub release page: <https://github.com/Ap6pack/outrider-recon/releases/tag/v4.0.0>. Download `outrider-recon-bundle-4.0.0.zip`, verify the relevant checksum entry, extract it into a review directory, inspect `RELEASE-MANIFEST.json`, and then follow the Claude skill installation method for your Claude surface. No Claude Marketplace publication is claimed.
